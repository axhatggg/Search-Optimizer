...
`;
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('  API responded but health check failed');
      }
    } catch (error) {
      console.log('  Could not connect to API (this is normal if your backend is not running yet)');
...
if (typeof fetch === 'undefined') {
  console.log('  Node.js 18+ is required for API testing');
